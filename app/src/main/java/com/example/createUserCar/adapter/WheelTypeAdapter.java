...
public class WheelTypeAdapter extends ArrayAdapter<WheelTypeModel> {

    public WheelTypeAdapter(Context context,
                                   List<WheelTypeModel> modelArrayList) {
    ...
    private View initView(int position, View convertView,
        ...
        WheelTypeModel currentItem = getItem(position);
